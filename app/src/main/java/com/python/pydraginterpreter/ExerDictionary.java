...
public class ExerDictionary extends AppCompatActivity {
        ...
        if ( currentScore == 15) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerDictionary.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerDictionary.this, "Congrats! You've unlocked the Python Functions.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerDictionary.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.tvAns3) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("remove");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("remove");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("remove");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
                    ...
                    if (view.getId() == R.id.tvAns4) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("del");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));

                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("del");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("del");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
                    ...
                    if (view.getId() == R.id.tvAns5) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("pop");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("pop");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("pop");
