...
public class ExerFunctions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_functions);
        ...
        if ( currentScore == 16) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerFunctions.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerFunctions.this, "Congrats! You've unlocked the Python Arrays.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerFunctions.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.tvAns2) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("myFunc");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("myFunc");
