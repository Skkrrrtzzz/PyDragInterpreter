...
public class ExerIfElse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_if_else);
        ...
        if ( currentScore == 8) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerIfElse.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerIfElse.this, "Congrats! You've unlocked the Python For Loop.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerIfElse.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
