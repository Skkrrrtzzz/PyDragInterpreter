...
public class ExerLists extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_lists);
        ...
        if ( currentScore == 12) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerLists.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerLists.this, "Congrats! You've unlocked the Python Tuples.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerLists.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.tvAns7) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("0");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("0");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("0");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
