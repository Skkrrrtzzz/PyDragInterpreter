...
public class ExerTuples extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_tuples);
        ...
        if ( currentScore == 13) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerTuples.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerTuples.this, "Congrats! You've unlocked the Python Sets.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerTuples.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.tvAns3) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("5");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("5");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("5");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
                    ...
                    if (view.getId() == R.id.tvAns4) {
                        ...
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("-1");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("-1");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
                    ...
                    if (view.getId() == R.id.tvAns5) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("last");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("last");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("last");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
                    ...
                    if (view.getId() == R.id.tvAns7) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("2:5");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("2:5");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget3) {
                            dropTarget3.setText("2:5");
                            dropTarget3.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                    }
