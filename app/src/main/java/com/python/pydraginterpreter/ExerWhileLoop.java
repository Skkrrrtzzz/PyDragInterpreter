...
public class ExerWhileLoop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exer_while_loop);
        ...
        if ( currentScore == 10) {
            ...
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ExerWhileLoop.this, MainDesign.class);
                    overridePendingTransition(0, 0);
                    startActivity(intent);

                    Toast.makeText(ExerWhileLoop.this, "Congrats! You've unlocked the Python Quiz Two.", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            btnContinue.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Toast.makeText(ExerWhileLoop.this, "Success!", Toast.LENGTH_SHORT).show();
                }
            });
        }
            ...
            switch (dragEvent) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.tvAns5) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("sum");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("sum");
                    ...
                    if (view.getId() == R.id.tvAns7) {
                        if(v.getId() == R.id.tvDropTarget1) {
                            dropTarget1.setText("counter");
                            dropTarget1.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
                        if(v.getId() == R.id.tvDropTarget2) {
                            dropTarget2.setText("counter");
                            dropTarget2.setBackgroundColor(Color.parseColor("#EC7063"));
                        }
