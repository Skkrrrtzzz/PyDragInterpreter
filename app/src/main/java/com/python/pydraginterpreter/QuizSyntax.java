...
public class QuizSyntax extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_syntax);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(QuizSyntax.this, MainActivity.class);
                overridePendingTransition(0, 0);
                startActivity(intent);

                Toast.makeText(QuizSyntax.this, "1", Toast.LENGTH_SHORT).show();
                //overridePendingTransition(0, 0);
